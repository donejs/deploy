...
if (process.argv.length < 3) {
	console.error("'donejs-package' requires the destination directory to be passed as an argument.");
	process.exit(1);
}
...
try {
	...
	console.log("Unable to get information about the destination directory.");
	process.exit(1);
}
